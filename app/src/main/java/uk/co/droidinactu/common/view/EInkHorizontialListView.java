...
public class EInkHorizontialListView extends AdapterView<ListAdapter> {

    protected ListAdapter mAdapter;

    public EInkHorizontialListView(final Context context) {
        super(context);
    ...
    @Override
    public void setAdapter(final ListAdapter arg0) {
        // TODO Auto-generated method stub
