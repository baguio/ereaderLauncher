 ...
 * sort by book series
 */
public class CalibreBookComparatorSeries implements Comparator<CalibreBook> {

    @Override
    public int compare(final CalibreBook o1, final CalibreBook o2) {
        final String c1 = o1.getSeries() + " " + o1.getSeriesIndex();
        final String c2 = o2.getSeries() + " " + o2.getSeriesIndex();
