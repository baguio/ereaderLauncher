...
public class MimeTypes {
    ...
    public static final String MIME_TYPE_KINDLE = "application/azw";
    public static final String MIME_TYPE_LIT = "application/lit";
    public static final String MIME_TYPE_MOBI = "application/mobi";
    public static final String MIME_TYPE_OPEN_EBOOK = "application/opf";
