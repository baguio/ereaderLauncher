...
import uk.co.droidinactu.ebooklauncher.data.calibre.DbMetadata;
import uk.co.droidinactu.ebooklauncher.data.calibre.EBookMetaData;
import uk.co.droidinactu.ebooklauncher.data.calibre.RecentEBook;
